  ...
  <section className="py-20 bg-gray-900">
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Card 1: Teach2Give */}
        <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg transform hover:translate-y-2 hover:shadow-2xl transition-transform duration-500">
          <h3 className="text-xl font-semibold mb-4 text-teal-500">Software Development Trainee at Teach2Give</h3>
        ...
        {/* Card 2: ICTA */}
        <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg transform hover:translate-y-2 hover:shadow-2xl transition-transform duration-300">
          <h3 className="text-xl font-semibold mb-4 text-teal-500">Software Development Trainee at ICTA (ICT Authority of Kenya)</h3>
        ...
        {/* Card 3: CSK Leader */}
        <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg transform hover:translate-y-2 hover:shadow-2xl transition-transform duration-300">
          <h3 className="text-xl font-semibold mb-4 text-teal-500">Leader at Computer Society of Kenya (CSK)</h3>
        ...
        <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg transform hover:translate-y-2 hover:shadow-2xl transition-transform duration-500">
          <h3 className="text-xl font-semibold mb-4 text-teal-500">Microsoft Learn Student Ambassador</h3>
        ...
        <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg transform hover:translate-y-2 hover:shadow-2xl transition-transform duration-500">
          <h3 className="text-xl font-semibold mb-4 text-teal-500">Machine Learning Lead</h3>
