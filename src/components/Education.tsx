  ...
  <section className="py-20">
    <div className="container mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center items-center">
        ...
        <img src="https://th.bing.com/th/id/OIP.tBakW_oDRdDqR0JroWxjNgHaEM?w=315&h=180&c=7&r=0&o=5&pid=1.7"alt= "Kirinyaga University"className="rounded-md mb-4 h-40 w-full"/>
        ...
        <div className=" bg-gray-800 shadow-lg rounded-lg p-6 text-center hover:shadow-xl transition-shadow duration-300 ">
        <img src="https://th.bing.com/th?id=OIP.YEpxxIGDjjh60yLcyBNlXwAAAA&w=280&h=65&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2"alt= "Teach2give"className="rounded-md mb-4 h-40 w-full"/>
